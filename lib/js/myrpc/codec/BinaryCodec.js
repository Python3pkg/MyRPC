...
myrpc.codec.BinaryCodec.prototype.read_message_begin = function()
{
	...
	throw new myrpc.common.MessageHeaderException("Invalid message header");
...
myrpc.codec.BinaryCodec.prototype.read_string = function()
{
	...
	if (e instanceof URIError)
	    throw new myrpc.common.MessageDecodeException("Can't decode unicode string");
	else
	    throw e;
    }
...
myrpc.codec.BinaryCodec.prototype._read_dtype = function()
{
	...
	throw new myrpc.common.MessageDecodeException("Unknown data type " + dtype);
