...
myrpc.codec.BinaryCodec.prototype.read_string = function(_in_header)
{
	...
	if (e instanceof URIError) {
	    ...
	    exc = (_in_header ? new myrpc.common.MessageHeaderException(msg) :
		   new myrpc.common.MessageBodyException(msg));
	    throw exc;
	} else {
	    throw e;
	}
