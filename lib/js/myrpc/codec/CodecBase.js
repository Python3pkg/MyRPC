...
myrpc.codec.CodecException = function(msg)
{
    myrpc.common.MyRPCException.call(this, msg);
};

myrpc.codec.CodecException.prototype = Object.create(myrpc.common.MyRPCException.prototype);
myrpc.codec.CodecException.prototype.constructor = myrpc.codec.CodecException;
